...
date: 2026-04-03
tags: ["engineering", "history", "meta"]
---

Many a day ago, I experimented with generative art using [p5.js](https://p5js.org/). 
...
[^2]: Over the years, its reputation has been a rollercoaster: iframes were the backbone of early "mashups" and third-party widgets (think Google Maps or YouTube embeds), but also became a notorious vector for clickjacking and [cross-site scripting (XSS)](https://en.wikipedia.org/wiki/Cross-site_scripting) attacks. Modern web standards like HTML5 eventually rehabilitated the element by introducing the sandbox attribute, providing the security controls necessary to keep it relevant in an era of complex web applications and micro-frontends.